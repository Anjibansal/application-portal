...
include 'excelSheetServer.php';
     ...
     $conn = new mysqli($dbhost,$dbuser,$dbpass,$db);
              ...
              if(!$conn)
            {
             ...
             $selectSQL = 'SELECT * FROM `bba_details`';
...
<html>
    ...
    <body>
       ...
       <div class="container-fluid">
           <h3 class="topic">Details of Students enrolled in BBA</h3>
    ...
    <div class="row">
        <div class="panel panel-primary filterable">
         ...
         <div class="btn">
            ...
            <button type="submit" id="btnExport" name='export_bba'
