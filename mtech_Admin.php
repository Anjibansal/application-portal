...
<html>
    ...
    <body>
       ...
       <div class="container-fluid">
           <h3 class="topic">Details of Students enrolled in MTech</h3>
    ...
    <div class="row">
        <div class="panel panel-primary filterable">
         ...
         <div class="btn">
             <form action="mtech_excel.php" method="post">
            <button type="submit" id="btnExport" name='export_mtech'
