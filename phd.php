    ...
    <div class="container">
        <div class="row">
            <div class="col-12">
                <div class="card">
                    <center>
                        <h2 class="topic">Apply for PhD</h2>
                    </center>
                </div>
                <div class="card">
                                ...
                                <form action="server.php" method="post">
                                    ...
                                    <div class="form-row">
                                        ...
                                        <div class="form-group col-md-3">
                                            ...
                                            <input type="text" class="form-control" name="Year_of_graduation_PG"
                                                required>
                                        </div>
                                        <div class="form-group col-md-3">
                                    ...
                                    <div class="form-row">
                                        <div class="form-group col-md-3">
                                            <label for="Noofpublication_conference">No of
                                                publication(conference)</label>
                                            <input type="text" class="form-control" name="Noofpublication_conference"
                                                required>
                                        </div>
                                        <div class="form-group col-md-3">
                                    ...
                                    <div class="form-row">
                                        <div class="form-group col-md-3">
                                            ...
                                            <input type="text" class="form-control" name="Experience_organisation"
                                                required>
                                        </div>
                                        <div class="form-group col-md-3">
