...
include 'excelSheetServer.php';
     ...
     $conn = new mysqli($dbhost,$dbuser,$dbpass,$db);
              ...
              if(!$conn)
            {
             ...
             $selectSQL = 'SELECT * FROM `mplan_details`';
...
<html>
    ...
    <body>
       ...
       <div class="container-fluid">
           <h3 class="topic">Details of Students enrolled in MPlan</h3>
    ...
    <div class="row">
        <div class="panel panel-primary filterable">
            ...
            <table class="table">
                <thead class="thead-dark">
                    ...
                    <tr class="filters">
                        ...
                        <th><input type="text" class="form-control" placeholder="Gate" disabled></th>
                        <th><input type="text" class="form-control" placeholder="Roll No." disabled></th>
                        <th><input type="text" class="form-control" placeholder="Year" disabled></th>
                        <th><input type="text" class="form-control" placeholder="Paper" disabled></th>
         ...
         <div class="btn">
             <form action="mplan_excel.php" method="post">
            <button type="submit" id="btnExport" name='export_mplan'
